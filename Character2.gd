...
func _process(delta):
	...
	var dir_to_targ = global_position.direction_to(to_local(look_at_target.global_position))
...
#    print('dotprod: ', dotprod) # should be -1 to 1
	...
	var angle1 = global_position.direction_to(to_local(look_at_target.global_position))
